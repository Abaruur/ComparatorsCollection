...
public class Room implements Comparable<Room>{
    //let's imagine that we wanted to compare our rooms using their daily rate.
    //we can build a comparator that overrides the natural order of the room.
    public static Comparator<Room> RATE_COMPARATOR = Comparator.comparing(Room::getRate);
    //.thenComparing(Room::getName);
    //  added this and worked for him but I couldn't.thenComparing(Room::getName);
    private String name;
